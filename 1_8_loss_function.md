...
**Câu hỏi 1**: _Giải thích tại sao hàm _$$g(\hat{y}, y) = \ - y \cdot \hat{y}$$_ lại thỏa mãn hai tiêu chí đã nêu ở trên._

**Câu hỏi 2**: _Giải thích tại sao hàm _$$g(\hat{y}, y) = \ - y \cdot \hat{y}$$_ lại không thỏa điều kiện của một loss function \(lưu ý tính chất của loss function và _$$f$$_\)._
